...
#ifndef DIRTYGEN_TRACKED_PAGES
#define DIRTYGEN_TRACKED_PAGES 128
#endif
#define DIRTYGEN_TRACKED_BITMAP_WORDS ((DIRTYGEN_TRACKED_PAGES + 63) / 64)
...
struct dirtygen_epoch_event {
  ...
  uint64_t actual_bitmap_reserved[2 - DIRTYGEN_TRACKED_BITMAP_WORDS];
  uint64_t guest_cycles;

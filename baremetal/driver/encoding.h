...
#define CLINT_BASE         (0x10000000+0x10000) //0x02000000
...
DECLARE_CSR(hgdtctl, CSR_HGDTCTL)
DECLARE_CSR(hgdts, CSR_HGDTS)
...
DECLARE_CAUSE("dirty log buffer fault", CAUSE_DIRTY_LOG_BUFFER_FAULT)
#endif
